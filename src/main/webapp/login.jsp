...
">
    ...
    <input type="text" name="username" required placeholder="Enter username" style="
    margin-bottom: 10px;
    border-radius: 15px;
"/>
...
"/>
    ...
    <p>Don't have an account? <a href="register.jsp" style="color:white;">Register here</a></p>
  </form>
</div>
